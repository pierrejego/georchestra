	...
	<div class="container">
		...
		<form:form id="form" name="form" method="post" action="new" modelAttribute="accountFromTokenFormBean" cssClass="form-horizontal col-lg-6 col-lg-offset-1" onsubmit="return validate();">
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<p class="form-control-static">
							${accountFromTokenFormBean.email}
						</p>
					</div>
				</div>
				...
				<form:input path="techId" type="hidden">
					<jsp:attribute name="label"><s:message code="techid.label" /></jsp:attribute>
				</form:input>
				<div class="form-group">
					<label class="col-lg-4 control-label"><s:message code="techid.label" /></label>
					<div class="col-lg-8">
						<p class="form-control-static">
							${accountFromTokenFormBean.techId}
						</p>
					</div>
				</div>
