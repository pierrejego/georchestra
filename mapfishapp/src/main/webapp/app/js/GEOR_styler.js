        ...
        var rulePanel = ruleContainer.add({
            ...
            pointGraphics: [
                {display: tr("circle"), value: "circle", mark: true,
                 preview: "app/js/styler/theme/PWRS/img/circle.gif"},
                {display: tr("square"), value: "square", mark: true,
                 preview: "app/js/styler/theme/PWRS/img/square.gif"},
                {display: tr("triangle"), value: "triangle", mark: true,
                 preview: "app/js/styler/theme/PWRS/img/triangle.gif"},
                {display: tr("star"), value: "star", mark: true,
                 preview: "app/js/styler/theme/PWRS/img/star.gif"},
                {display: tr("cross"), value: "cross", mark: true,
                 preview: "app/js/styler/theme/PWRS/img/cross.gif"},
                {display: tr("x"), value: "x", mark: true,
                 preview: "app/js/styler/theme/PWRS/img/x.gif"},
